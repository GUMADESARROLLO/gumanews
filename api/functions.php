...
class functions extends REST {
	...
	public function forgotPassword() {
		...
		if ($row['email']!="") {
			...
			$to = $_GET['email'];
			// subject
			$subject = '[IMPORTANT] Guma News App Forgot Password Information';
			//$message = '<div><strong>Confirmation Code</strong>:'.$new_password.'<br></div>';
			...
			$message='<div style="background-color: #f9f9f9;" align="center"><br />
					  <table style="font-family: OpenSans,sans-serif; color: #666666;" border="0" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#FFFFFF">
					    <tbody>
					                    ...
					                    <tbody>
					                      <tr>
					                        <td><p style="color: #262626; font-size: 28px; margin-top:0px;"><strong>Dear '.$row['name'].'</strong></p>
					                          <p style="color:#262626; font-size:20px; line-height:32px;font-weight:500;">Thank you for using Guma News App,<br>
					      ...
					      <tr>
					        <td style="color: #262626; padding: 20px 0; font-size: 20px; border-top:5px solid #52bfd3;" colspan="2" align="center" bgcolor="#ffffff">Copyright © Guma News App.</td>
					      </tr>
					    </tbody>
					  </table>
					</div>';
                ...
                //Recipients
                $mail->setFrom('noreply@company.com', 'Guma - News');
                $mail->addAddress($_GET['email'],$row['name']);

                //Content
                $mail->isHTML(true);
                $mail->Subject = 'GUMA  - News';
                $mail->Body    = $message;
